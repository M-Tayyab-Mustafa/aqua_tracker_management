...
class AboutUsScreen extends StatelessWidget {
  ...
  static const String path = '/about_us_screen';
        ...
        child: ListView(
          children: [
            Text.rich(TextSpan(children: [
              TextSpan(text: '\nWelcome to', style: Theme.of(context).textTheme.bodyLarge),
              TextSpan(text: '(CAS)', style: Theme.of(context).textTheme.titleMedium),
              TextSpan(
                text:
              ...
              TextSpan(text: '(Tayyab)', style: Theme.of(context).textTheme.titleMedium),
              TextSpan(
                  text:
            ...
            Text.rich(TextSpan(children: [
              ...
              TextSpan(text: 'At CAS, our vision is twofold:\n', style: Theme.of(context).textTheme.bodyLarge),
              TextSpan(text: 'Develop Excellent Developers:\n', style: Theme.of(context).textTheme.titleMedium),
              TextSpan(
                  text:
            ...
            Text.rich(TextSpan(children: [
              TextSpan(text: '\nOur Mission\n', style: Theme.of(context).textTheme.headlineSmall),
              TextSpan(text: 'Our mission at CAS is a dual one:\n', style: Theme.of(context).textTheme.bodyLarge),
              TextSpan(text: 'Foster Developer Excellence:\n', style: Theme.of(context).textTheme.titleMedium),
              TextSpan(
                  text:
