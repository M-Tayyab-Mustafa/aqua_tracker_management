...
class CustomDragAbleCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      padding: margin ?? const EdgeInsets.all(smallestPadding),
      child: Dismissible(
        key: key!,
        ...
        background: Align(
          ...
          child: Icon(Icons.edit_note_rounded,
              color: Colors.greenAccent, size: buttonSize.height * 0.7),
        ),
        secondaryBackground: Align(
          alignment: Alignment.centerRight,
          child: Icon(Icons.delete,
              color: Colors.red, size: buttonSize.height * 0.7),
        ),
        child: CustomCard(
          ...
          onTap: onTap,
          child: Padding(
            padding: padding ?? const EdgeInsets.all(smallestPadding),
            child: child,
          ),
        ),
      ),
